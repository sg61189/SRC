...
python3 MAB_BMC_fixt_n.py -i benchmark/HWMCC_15_17/${fn}.aig > logs_MC/log_mabmc_fix_IF_${fn}_D3.txt
echo "----------------- Running MAB_bmc_new ------------------"
python3 MAB_BMC_new_n.py -i benchmark/HWMCC_15_17/${fn}.aig > logs_MC/log_mabmc_IF_${fn}_D3.txt
