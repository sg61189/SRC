...
for file in "${files[@]}"; do
    ...
    python3 -u ~/bmc-gnn2/main_noninductive.py -f -input_circuit "${input_dir}/${file}" -csv_path "${csv_path}" -unfold_path /tmp -total_time 3600 -p 0.2 -chosen_circuit_path "${chosen_circuit_dir}" -T 60 -UNFOLD_FRAME 1 | tee -a /home/src2024/bmc-gnn2/results/2x/non-inductive/17_2x_non-inductive_0.2.txt
