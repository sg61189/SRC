...
#------THIS SCRIPT FOR KMEDOIDS AND NON PCA ------
set designName=$1
...
set cluster_Info_Location="../../../output/cluster_output"
echo $pickle_File_Location
set output_struct_filename=$designName"_outputS-cosine_Kmedoids.txt"
set output_funct_filename=$designName"_outputF-cosine_Kmedoids.txt"
...
python3 ../../python_Scripts/clusterGen/clustering_v1.py --n $clusterCount  --input_dir $struct_Pickle_Folder  --method kmedoids --distance_metric cosine > $struct_cluster_filename
echo "Struct Cosine similarity printed on file | Status: $?"
python3 ../../python_Scripts/clusterGen/clustering_v1.py --n $clusterCount   --input_dir $funct_Pickle_Folder  --method kmedoids --distance_metric cosine > $funct_cluster_filename
echo "Funct Cosine similarity printed on file | Status: $?"
