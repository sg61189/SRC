...
designName=$1
output_struct_filename=$designName"_outputS-cosine_Kmedoids.txt"
output_funct_filename=$designName"_outputF-cosine_Kmedoids.txt"
python3 /home/prateek/soumikSep13/clustering_v1.py --input_dir ./$designName/structPkl --method kmedoids --distance_metric cosine > /home/prateek/soumikSep13/cluster_Info/$output_struct_filename
echo "Struct Cosine similarity printed on file "
python3 /home/prateek/soumikSep13/clustering_v1.py  --input_dir ./$designName/funcPkl --method kmedoids --distance_metric cosine > /home/prateek/soumikSep13/cluster_Info/$output_funct_filename
